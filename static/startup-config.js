document.addEventListener("DOMContentLoaded", () => {
    ...
    device_cards.forEach((device_card, index) => {
        ...
        if (stored_devices[device_key]){
            ...
            //Function to pre-populate input field from database
        ...
        form.addEventListener('submit', async (e) => {
            ...
            if(!is_valid){
                ...
                function deviceInfo(device_id){
                    ...
                    //Appending device info to devices object
            ...
            try{
                const response = await fetch('/api/start_config', {
                    method: 'POST',
                ...
                if(response.ok){
                    ...
                    alert("Startup Configuration saved to file")
